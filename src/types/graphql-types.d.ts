...
export type IndexQueryQuery = { site?: Maybe<{ meta?: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'siteUrl' | 'author' | 'twitter' | 'adsense'>> }>, remark: { posts: Array<{ post: (
        ...
        & { frontmatter?: Maybe<(
          Pick<MarkdownRemarkFrontmatter, 'layout' | 'title' | 'path' | 'tags' | 'description' | 'date'>
...
export type TagsPageQueryQuery = { tags: { group: Array<{ text: MarkdownRemarkGroupConnection['fieldValue'], value: MarkdownRemarkGroupConnection['totalCount'] }> } };
...
export type Unnamed_1_Query = { data: (
    Pick<MarkdownRemarkConnection, 'totalCount'>
    & { tags: Array<{ node: { frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'path'>> } }> }
  ) };
